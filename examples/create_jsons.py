...
extract_models_params = {
    ...
    "mtypes_file": None,  # '/gpfs/bbp.cscs.ch/project/proj82/simulations/cell_synthesis_distributions/dat_files_correction/neurondb_05_RepairUnravel.dat',
    ...
    "asymetry_threshold": {"apical": 0.2, "basal": 1.0},
    "n_samples": 2,
    "seed": 0,
    "trunk_max_tries": 100,
    "n_cpu": 2,
